...
function googleSearchToVertex$2(fromObject) {
  ...
  const fromExcludeDomains = getValueByPath(fromObject, ["excludeDomains"]);
...
var ApiClient = class {
  ...
  request(request) {
    return __async(this, null, function* () {
      ...
      requestInit = yield this.includeExtraHttpOptionsToRequestInit(requestInit, patchedHttpOptions, request.abortSignal);
  ...
  includeExtraHttpOptionsToRequestInit(requestInit, httpOptions, abortSignal) {
    return __async(this, null, function* () {
...
function createTuningJobConfigToVertex(fromObject, parentObject) {
  ...
  const fromPreTunedModelCheckpointId = getValueByPath(fromObject, ["preTunedModelCheckpointId"]);
